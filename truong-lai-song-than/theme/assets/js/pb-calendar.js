jQuery(function($) {
    ...
    window.PB_CALENDAR_DEFAULTS = {
        ...
        'min_yyyymm': null,
        'max_yyyymm': null,
        'next_month_button': '<i class="fa fa-angle-right" aria-hidden="true"></i>',
        'prev_month_button': '<i class="fa fa-angle-left" aria-hidden="true"></i>',

        'month_label_format': "MM",
    ...
    var _pb_calendar = (function(target_, options_) {
        ...
        this._target.append('<div class="top-frame">' +
            ...
            '<span>Tháng</span><span class="month"></span>' +
            '<span>năm</span><span class="year"></span>' +
            '</div>' +
        ...
        this._target.append('<div class="calendar-head-frame">' +
            ...
            '<div class="col col-dayname holiday">T2</div>' +
            '<div class="col col-dayname">T3</div>' +
            '<div class="col col-dayname">T4</div>' +
            '<div class="col col-dayname">T5</div>' +
            '<div class="col col-dayname">T6</div>' +
            '<div class="col col-dayname">T7</div>' +
            '<div class="col col-dayname">CN</div>' +
            '</div>' +
            '</div>');
